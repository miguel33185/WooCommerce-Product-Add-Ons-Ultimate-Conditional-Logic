...
echo "</pre>";
echo "<pre>";
echo "field_id: ".$field_id."<br>item: ";
print_r($item);
echo "group[items]: ";
print_r($group['items']);
echo "<br>product_id: ".$product_id."<br>_POST: ";
print_r($_POST);
echo "<br>variation_id: ".$variation_id."<br>quantity: ".$quantity."<br>group_id:".$group_id."<br>group: ";
print_r($group);
print_r($cart_item_data);
echo "</pre>";*/
