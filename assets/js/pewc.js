(function($) {
	...
	/*$('.variations_form.cart').submit(function(){
		$('#pa_awning-fabric-colors option').val(function(){
		   return $(this).text();
		});
		$('#pa_awning-width option').val(function(){
		   return $(this).text();
		});
		$('#pa_awning-crank-type option').val(function(){
		   return $(this).text();
		});		
	});*/
})(jQuery);
